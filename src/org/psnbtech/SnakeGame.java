...
public class SnakeGame extends JFrame {
	...
	//ตัวเช็คว่าgameover ไหม
	private boolean isGameOver;
	
	//ตัวเช็คว่าpause อยู่ไหม
	private boolean isPaused;	
	//Linkedlist สำหรับเก็บขนาดของงู.
	private LinkedList<Point> snake;	
	 //เก็บการทิศทางของตัวงูโดยการ Queue.
	private LinkedList<Direction> directions;
	 //คะแนนปัจจุบัน	
	private int score;
	 //จำนวนที่กินแอปเปิ้ลไป.
	private int fruitsEaten;	
	//จำนวนแต้มของแอปเปิ้ลที่เหลืออยู่
